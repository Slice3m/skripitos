...
'Credits'K:AddLabel'Avilon - Creator'K:AddLabel'Inori @v3rm - UI Library'K
...
'> brickmane @v3rm'local L=J:AddRightGroupbox
'Socials'L:AddButton('Discord Server',function()setclipboard
'https://discord.gg/pacifamily'end)end do local J=I:AddTab'Settings'm:
...
Toggles.Watermark.Value)end)end end l:LoadAutoloadConfig()do local I local J,
...
Range=200 return k:Unload() --remove this unload to get menu
